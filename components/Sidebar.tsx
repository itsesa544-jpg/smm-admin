...
import { LayoutDashboard, Users, ShoppingCart, List, DollarSign, MessageSquare, Settings, X } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ currentPage, setCurrentPage, isOpen, setIsOpen }) => {
  ...
  return (
    <aside className={`fixed top-0 left-0 z-40 w-64 h-screen bg-sidebar text-sidebar-text flex-shrink-0 transform transition-transform duration-300 ease-in-out lg:relative lg:translate-x-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
